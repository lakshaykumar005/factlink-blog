# How can I customize the `kbar` search for Factlink Blog?
...
This will ensure that search and recommendations are based on the actual Factlink blog content, including title, summary, tags, and full text.
